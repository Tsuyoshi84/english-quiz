...
const phrases = [
  ...
  },
  {
    ...
    examples: ["I'm going to bite the bullet and quit my job."],
  },
  {
    body: 'cut corners',
  ...
  },
  {
    ...
    examples: ["I'm on thin ice after my behaviour at the office party."],
  },
  {
  ...
  { body: 'to see eye to eye', meaning: 'to agree', examples: ["I really don't see eye to eye with my grandma."] },
  {
  ...
  },
  {
    ...
    examples: ['He stuck with her through thick and thin.'],
  },
  {
  ...
  { body: 'put something to bed', meaning: 'to finish dealing with something', examples: ['I hope we can finally put this issue to bed.'] },
  {
  ...
  },
  {
    ...
    examples: ["Reading between the lines, I'd say he isn't happy with the situation."],
  },
  {
  ...
  },
  {
    ...
    examples: ['Corruption is a serious problem, but nobody has yet been willing to open up that can of worms.'],
  },
  ...
  },
  {
    ...
    examples: ['In light of your good driving record, we’ve decided to overlook this offense.'],
  },
