...
const phrases = [
  { body: 'on the whole', meaning: 'generally', example: "We have our bad times but on the whole we're fairly happy." },
  {
    body: 'on the second thoughts',
    meaning: 'used when you want to change something that you have just said, often to say the opposite',
    example: 'We don’t need an umbrella. On second thoughts, maybe we do.',
  },
  {
  ...
  },
  {
    ...
    example: "Off the top of my head, I think she's been engageed 5 times.",
  },
  {
    body: 'out of touch',
    meaning: 'not communicating with each other',
    example: "I don't know if he still lives there. We've been out of touch for some time.",
  },
  {
    body: 'get my head around it',
    meaning: 'To understand something that is challenging or confusing.',
    example: "It took a while, but I've finally gotten my head around this chapter in my calculus textbook.",
  },
  {
    body: 'by and large',
  ...
  { body: 'cost an arm and a leg', meaning: 'very expensive', example: 'The repair work cost an arm and a leg' },
  { body: 'cost a fortune', meaning: 'to be very expensive', example: 'That cost looks like it cost you an arm and a leg!' },
  { body: 'dirt cheap', meaning: 'very cheap', example: "They're always selling off stuff like that dirt cheap" },
  {
    body: 'rip someone off',
    meaning: 'cheat someone, especially financially',
    example: 'She thought he was ripping her off over her royalties',
  },
  {
    body: 'issue a refund',
    meaning: 'to return the money you have received',
    example: 'Sometimes, for any number of reasons, you may have to issue a refund.',
  },
  { body: 'make ends meet', meaning: 'to earn just enough money to live on', example: 'They were finding it hard to make ends meet.' },
  { body: 'cheapskate', meaning: 'a miserly person.', example: 'He is such a cheapskate.' },
  {
    body: 'go Dutch',
    meaning: 'To divide a check or bill so that each person contributes to it.',
    example: "You don't have to treat me to dinner—let's go Dutch.",
  },
  {
  ...
  },
  {
    ...
    example: "I don't know what her job is but she certainly seems to have money to burn.",
  },
  { body: 'when hell freezes over', meaning: 'it will never happen', example: 'I guess, she will forgive you when hell freezes over' },
  { body: 'when pigs fly', meaning: 'it will never happen', example: 'The train station will be renovated when pigs fly' },
  {
    body: "odds are in someone's favor",
    meaning: '(someone) is likely to win or succeed',
    example: "We don't know what the decision will be, but we think the odds are in our favor.",
  },
  {
    body: 'tit for tat',
  ...
  { body: 'right off the bat', meaning: 'immediately or right from the start', example: 'I found what I wanted right off the bat.' },
  {
    body: 'an old wives’ tale',
    meaning: 'A now-debunked story or idea that was once believed, often superstitiously.',
    example: "Oh, that's just an old wives' tale! A broken mirror does not guarantee seven years' bad luck.",
  },
  { body: 'there is no doubt that', meaning: '100 %', example: 'There is no doubt that she is angry.' },
  {
    body: 'if you ask me',
    meaning: "used to emphasize that a statement is one's personal opinion",
    example: 'If you ask me, people should go on a training course before they become parents.',
  },
  {
    body: 'a blessing in disguise',
    meaning: 'a good thing that seemed bad at first',
    example: 'Loosing that job was a blessing in disguise.',
  },
  {
    body: 'a picture is worth 1000 words',
    meaning: 'a picture tells a story just as well as, if not better than, written words',
    example: 'Please could you sketch out a floorplan? A picture is worth a thousand words.',
  },
  {
    body: 'actions speak louder than words',
    meaning: 'what someone actually does means more than what they say they will do',
    example: "I'm going to wait for him to show me he loves me because actions speak louder than words.",
  },
  {
  ...
  { body: 'as cheap as chips', meaning: 'really cheap', example: "Don't worry about paying me back, they were as cheap as chips." },
  {
    body: 'bark up the wrong tree',
    meaning: 'to be wrong about the way to achieve something or the reason for something',
    example: "I think you're barking up the wrong tree. Rather than reading the textbook cover to cover, you should try the SQRRR method.",
  },
  {
  ...
  },
  {
    ...
    example: 'Because it was the last day of class, the teachers cut the students some slack.',
  },
  {
  ...
  },
  {
    ...
    example: "I'm applying for several jobs because I don't want to put all of my eggs in one basket.",
  },
  {
    body: 'easy does it',
  ...
  },
  {
    ...
    example: 'Every cloud has a silver lining - after being made redundant I found my dream job!',
  },
  {
    body: 'get a taste of your own medicine',
    meaning: "get treated the way you've been treating other people",
    example: 'The nasty prison warden got a taste of his own medicine after being thrown in jail.',
  },
  {
    ...
    example: 'I went and bought that dress I was thinking about all day - I  had to get it out of my system!',
  },
  {
  ...
  },
  {
    ...
    example: 'She said she was late because her train was cancelled, and we gave her the benefit of the doubt.',
  },
  { body: 'to give someone the cold shoulder', meaning: 'to ignore someone', example: 'I think Sally is giving me the cold shoulder.' },
  {
  ...
  { body: 'good things come to those who wait', meaning: 'be patient', example: 'Stop rushing me! Good things come to those who wait!' },
  {
  ...
  { body: 'it takes one to know one', meaning: "you're just as bad as I am", example: "You're such a gossip! It takes one to know one." },
  {
  ...
  },
  {
    ...
    example: 'I think we should let sleeping dogs lie and avoid confronting her about her issues.',
  },
  {
    ...
    example: "This is the third time you've been caught speeding and I don't think they're going to let you off the hook.",
  },
  {
  ...
  },
  {
    ...
    example: "I don't want to play devil's advocate but are you really going out dressed like that?",
  },
  {
    body: "to rain on someone's parade",
    meaning: 'to spoil something',
    example: "I don't want to rain on your parade but I think you've made a huge mistake in your thesis.",
  },
  {
  ...
  { body: 'to see eye to eye', meaning: 'to agree', example: "I really don't see eye to eye with my grandma." },
  {
    body: 'to shed light on something',
    meaning: 'to reveal information about or to clarify something',
    example: 'Please could you shed some light on your absense yesterday?',
  },
  {
  ...
  },
  {
    ...
    example: 'I thought he was really nice, but then he was rude to the waiter and showed his true colours.',
  },
  { body: 'to spill the beans', meaning: 'give away a secret', example: 'Go on, spill the beans! I need to know how your date went!' },
  {
    ...
    example: 'She stole my thunder when she announced her pregnancy at my wedding!',
  },
  {
  ...
  { body: 'to take the mickey', meaning: 'to make fun of', example: 'Are your taking the mickey of my mum?' },
  {
    body: 'the ball is in your court',
    meaning: "it's your decision",
    example: 'The ball is in your court regarding the location of the next event.',
  },
  {
  ...
  },
  {
    ...
    example: 'The illustrations looked fine at first glance, but the devil is in the details.',
  },
  {
    body: 'the early bird gets the worm',
    meaning: 'the people who arrive first will get the best stuff',
    example: "Let's head to the sales at 6 am - the early bird gets the worm!",
  },
  {
    body: 'the last straw',
  ...
  },
  {
    ...
    example: "I wonder what he wants from me? There's no such thing as a free lunch!",
  },
  {
    body: 'through thick and thin',
    meaning: 'under all circumstances, no matter how difficul',
    example: 'He stuck with her through thick and thin.',
  },
  {
  ...
  },
  {
    ...
    example: 'She accidently sent a romantic message to her family whatsapp group, and to make matters worse it included a picture.',
  },
  {
  ...
  },
  {
    ...
    example: 'The fate of our house purchase is still up in the air!',
  },
  {
    ...
    example: "Don't worry about the car breaking down - we'll cross that bridge when we come to it.",
  },
  {
  ...
  },
  {
    ...
    example: '"He\'s driving me crazy with his stupid jokes." "Tell me about it!"',
  },
  {
    body: "you can't have your cake and eat it too",
    meaning: "you can't have everything",
    example: "You need to choose between the two options - you can't have your cake and eat it too!",
  },
  {
    body: 'you live and you learn',
    meaning: 'you learn from your mistakes',
    example: 'I know I failed the interview but you live and you learn.',
  },
  { body: 'year after year', meaning: 'it’s done every year', example: 'He celebrates Christmas with his family in Rome year after year.' },
  {
    body: 'passed down in one’s family',
    meaning: 'something is given from generation to generation in a family',
    example: 'The painting has been passed down in her family.',
  },
  {
    body: 'to have a crush on someone',
    meaning: 'to like a person in a romantic way.',
    example: 'Do you think the man has a crush on the woman?',
  },
  {
    body: 'to pop the question',
    meaning: 'to ask for someone’s hand in marriage',
    example: 'Yesterday, Jason popped the question to Janice.',
  },
  { body: 'to tie the knot', meaning: 'to get married', example: 'Janice said yes! They’re going to tie the knot later this year!' },
  { body: 'tell like it is', meaning: "to tell the whole truth even if it's not very pleasant", example: 'She always tells like it is.' },
  {
    body: "get one's foot in the door",
    meaning: 'to do something that may give you a chance at better opportunities in the future.',
    example: 'Giving your contact details to someone in the company is a way to get your foot in the door.',
  },
  {
    body: 'out of courtesy',
    meaning: 'to do something in order to be polite, not because they want to do it',
    example: 'She was really busy, but she invited the visitor to lunch out of courtesy',
  },
  {
    body: 'It’s customary to',
    meaning: 'it used to talk about things that are commonly done',
    example: 'At my company, it’s customary to wear slippers inside the office.',
  },
  {
    body: 'to manage to do something',
    meaning: 'to succeed in doing something difficult',
    example: 'I managed to graduate while working a full-time job.',
  },
  {
    body: 'to take pride in something',
    meaning: 'someone is proud of a specific achievement',
    example: 'I take pride in graduating from a well-known university.',
  },
  {
    body: 'to rob the cradle',
    meaning: 'to marry or date someone who is much younger than you',
    example: "Robert is 45 and his girlfriend is only 25. This isn't the first time he's robbed the cradle.",
  },
  {
    body: 'a May-December romance',
    meaning: 'a relationship between two people who have a fuge age gap',
    example: "I'm 28 and my hasband is 52, so it's quite a Mey-December romance.",
  },
  {
    ...
    example: 'I don’t have time to go on dates! Right now, my career is at the top of the list.',
  },
  {
  ...
  { body: 'frown on something', meaning: 'not to approve', example: 'My mother frowns on using martphones at the dinner table.' },
  {
    ...
    example: 'The shop is named "Tea-rrific" and it’s a play on words. It’s a mix of ‘tea’ and ‘terrific.’',
  },
  {
    body: 'to put a lot of thought into something',
    meaning: 'to think carefully about it.',
    example: "Give her something unique. She'll appriciate that you put a lot of thought into your gift.",
  },
  {
    body: 'to seize the day',
    meaning: 'to enjoy the present moment without worrying about the future.',
    example: 'Don’t worry about your household chores! It’s a nice day out. Let’s seize the day and go hiking!',
  },
  {
    body: 'live life to the fullest',
    meaning: 'to live the best life possible without holding back',
    example: 'Live life to the fullest! You only get one life, you know?',
  },
  {
    ...
    example: 'Try to give her flowers as an apology. It may not work, but it’s worth a shot.',
  },
  {
    body: 'in due course',
    meaning: 'something will happen at the appropriate time',
    example: 'Don’t worry too much. You’re still young. You’ll find a good partner in due course.',
  },
  {
    body: 'save for a rainy day',
    meaning: 'to keep something, especially money, for a future time of need',
    example: "I've been saving for a rainy day. I already have a couple thousand dollars in my account.",
  },
  {
    body: 'something is on my mind',
    meaning: 'a person has been thinking about something a lot',
    example: 'Going to the beach has been on my mind for a while now, so  I just bought a ticket to Bali!',
  },
  {
    body: 'pressure someone into doing something',
    meaning: 'to strongly push a person to do it',
    example: "I didn't really want attend the party, but my friend pressured me into going.",
  },
  {
  ...
  },
  {
    ...
    example: '‘But some of those kids can hardly read or write!’ ‘All the more reason why they should get the best education on offer.’',
  },
  {
  ...
  },
  {
    ...
    example: 'I found it weird that some locals hail a cab by whistling at an oncoming taxi, but somehow, it works!',
  },
  {
    body: 'blend in',
  ...
  },
  {
    ...
    example: 'If the viewing figures drop much more, the TV network will probably pull the plug on the whole series.',
  },
  {
    body: 'hit a snag',
    meaning: 'to encounter an issue, drawback, or challenge.',
    example: 'Our plans for a relaxing night at home hit a snag when a pipe burst in the basement.',
  },
  {
  ...
  { body: "the sky's the limit", meaning: 'there is no limit', example: "The sky's the limit to what you can win in our competition." },
  {
    body: 'quid pro quo',
  ...
  },
  {
    ...
    example: "Don't split hairs. You know what I'm getting at.",
  },
  {
  ...
  },
  {
    ...
    example: "He's always been a good friend, but while I was ill he really went above and beyond",
  },
  { body: 'put something to bed', meaning: 'to finish dealing with something', example: 'I hope we can finally put this issue to bed.' },
  {
    body: 'tie up loose ends',
    meaning: 'to complete the parts of something that have not been completed',
    example: 'We still have to tie up some loose ends of the project.',
  },
  {
  ...
  },
  {
    ...
    example: 'I try to stay away from him as much as possible. He’s such a loose cannon!',
  },
  {
    body: 'a red flag',
    meaning: 'a sign that something is wrong',
    example: 'Losing your enthusiasm for what you’re studying is a red flag. Maybe you should consider changing your major?',
  },
  {
    body: 'trust your gut ',
    meaning: 'an expression used to say that you should trust how you feel, especially if something seems wrong',
    example: 'Don’t go on the trip if you have a bad feeling about it. Trust your gut.',
  },
  {
    body: 'I hate to break it to you',
    meaning: 'an expression used to say some bad news',
    example: 'I hate to break it to you, but he is not here.',
  },
  { body: 'to die for', meaning: 'excellent or to be strongly wished for', example: 'That chocolate cake is to die for.' },
  {
    body: 'not by a long shot',
    meaning: 'used for saying that something is not true at all',
    example: 'They’ve achieved a lot, but they haven’t finished yet – not by a long shot.',
  },
  {
    body: 'since the beginning of time',
    meaning: 'As long as anyone can remember',
    example: 'Since the beginning of time, man has always sought ways of improving things and of going about it.',
  },
  {
    body: "give the shirt off one's back",
    meaning: 'give anything and everything one possesses',
    example: "Tom is truly generous—he'll give you the shirt off his back. ",
  },
  {
  ...
  },
  {
    ...
    example: 'There will always be people in this business looking to exploit you, so you can never let your guard down.',
  },
  {
    body: 'scratch that',
    meaning: 'set phrase An interjection telling someone to ignore, forget, or disregard what was just said or instructed.',
    example: "I wonder how much it would be to have our wedding inside the aquarium? Actually, scratch that, that's a ridiculous idea.",
  },
  {
  ...
  },
  {
    ...
    example: 'I like to watch snackable videos on YouTube.',
  },
  {
    body: 'memory like a sieve',
    meaning: 'to be exceptionally forgetful or absentminded.',
    example: "I need to start getting more sleep at night, because lately I've had a memory like a sieve.",
  },
  {
    ...
    example: 'The senator has been accused of trying to sweep his former drug use under the rug.',
  },
  {
    ...
    example: 'You want me to go shopping with you? Oh, be still my heart! No, thank you.',
  },
  {
    body: 'wild goose chase',
    meaning: 'a foolish and hopeless search for or pursuit of something unattainable.',
    example: 'After two hours spent wandering in the snow, I realized we were on a wild goose chase.',
  },
  {
    body: 'knock yourself out',
    meaning: 'to go ahead; to do as one pleases',
    example: '"These cookies are my favorite! Can I have some?" "Sure, knock yourself out"',
  },
  {
    body: 'under your own steam',
    meaning: 'If you do something under your own steam, you do it without help:',
    example: 'Do you want a lift or will you get there under your own steam?',
  },
  {
    ...
    example: 'They believe that the end justifies the means and will do anything to get their candidate elected.',
  },
  {
  ...
  { body: 'rain cats and dogs', meaning: 'rain very hard.', example: "It's raining cats and dogs." },
  {
  ...
  },
  {
    ...
    example: 'Someone smashed into my parked car right before my eyes.',
  },
  {
    body: 'in the flesh',
    meaning: 'in real life, and not on TV, in a film, in a picture, etc.:',
    example: "I've seen her perform on television, but never in the flesh.",
  },
  {
    body: 'you could have fooled me',
    meaning: 'used to show that you do not believe what someone has told you',
    example: 'Look, we’re doing our best to fix it.’ ‘Well, you could have fooled me.',
  },
  {
    body: 'without rhyme or reason',
    meaning: 'to be without any obvious reasonable explanation:',
    example: 'Government money was given out to some people and not to others, apparently without rhyme or reason.',
  },
  {
    body: 'not on my watch',
    meaning: 'That will not happen while I am in charge or on the lookout.',
    example: '"He uses a lot of chilli when he\'s cooking." "Not on my watch!"',
  },
  {
  ...
  },
  {
    ...
    example: 'It became a point of pride for the country to build its military to a size that could rival its peers on the global stage.',
  },
  {
    body: 'one way or another',
    meaning: 'in some way that is not stated',
    example: 'Everyone at the party was related (in) one way or another.',
  },
  {
    ...
    example: 'I think he laid it on a bit thick with all the compliments.',
  },
  {
    body: 'play silly buggers',
    meaning: 'to behave in a silly, stupid, or annoying way:',
    example: "There'll be a serious accident sooner or later if people don't stop playing silly buggers.",
  },
  {
    body: 'over the edg',
    meaning: 'into a mental or emotional state that makes someone completely lose control',
    example: 'His friends worried that the news might send/drive/push him over the edge.',
  },
  {
  ...
  },
  {
    ...
    example: '"we\'ve had a meeting as to the general terms, and now we\'re going to get down to brass tacks"',
  },
  {
    ...
    example: "Ah, don't get your knickers in a twist, I'll have the car back by tomorrow morning!",
  },
  {
    body: 'get reimbursed for something ',
    meaning: 'to be repaid for something that you spent or lost money on',
    example: 'You should get reimbursed for your canceled flight.',
  },
  {
    body: 'file a claim',
    meaning: 'make a written statement about a problem such as lost or damaged luggage.',
    example: 'I filed a claim after seeing that one of my luggage was heavily damaged by the airport staff.',
  },
  {
    body: 'stands up for',
  ...
  { body: '24/7', meaning: 'all the time', example: "You don't have to work 24/7." },
  {
    body: 'heart-to-heart',
  ...
  },
  {
    ...
    example: 'My mother never took sides when my brother and I argued.',
  },
  {
    body: 'be a long shot',
    meaning: ' used to say that a plan is worth trying, even though you think it is unlikely to succeed',
    example: 'It’s a long shot, but someone might recognise her from the photo and be able to tell us where she lives.',
  },
  {
  ...
  },
  {
    ...
    example: 'Investigators are trying to get to the bottom of what went wrong.',
  },
  {
    ...
    example: 'Leave it to you to have the whole day planned out!',
  },
  {
    body: 'get under someone’s skin',
    meaning: 'to make someone very annoyed or upset',
    example: 'Ignore Justin: don’t let him get under your skin',
  },
  {
  ...
  },
  {
    ...
    example: 'The trouble with John is he thinks the whole world revolves around him.',
  },
  {
  ...
  },
  {
    ...
    example: 'He was constantly looking over his shoulder, afraid his past crimes would catch up with him.',
  },
  {
    ...
    example: '"We had a really boring trip." "Speak for yourself! I had a wonderful time!"',
  },
  {
  ...
  },
  {
    ...
    example: 'These threats should not be taken at face value.',
  },
  {
    body: 'from where I stand',
    meaning: 'according to what I know or feel',
    example: 'I knew from where I stood that the stocks were practically worthless.',
  },
  {
    body: 'be all in',
    meaning:
    ...
    example: "Just so you know, I'm all in if you're serious about taking that cross-country trip next week.",
  },
  {
  ...
  { body: 'split second', meaning: 'a very short moment of time:', example: 'They brought out guns and for a split second nobody moved.' },
  {
    body: "hide (one's) light under a bushel",
    meaning: "To avoid utilizing or emphasizing one's talents.",
    example: "Don't give up drawing! You're a talented artist and shouldn't hide your light under a bushel.",
  },
  {
    body: 'on the rack',
    meaning: 'in a difficult situation that you cannot deal with',
    example: 'The government is on the rack over the torture allegations.',
  },
  {
  ...
  },
  {
    ...
    example: "All these questions you're asking are above your pay grade.",
  },
  {
    ...
    example: 'I know you’re stressed, but don’t take it out on me. I’m just trying to help.',
  },
  {
    body: 'have a lot on one’s plate',
    meaning: 'be very busy',
    example: 'Sorry, I can’t really help you right now. I have a lot on my plate today.',
  },
  {
    body: 'put on weight',
    meaning: 'gain weight',
    example: 'I noticed that I’m putting on weight lately, so I decided to cut back on bread and sugar.',
  },
  {
    body: 'feel good about oneself',
    meaning: 'have self-confidence and high self-esteem.',
    example: 'I didn’t use to feel good about myself, but now, I’m confident about my appearance and love taking photos with my friends.',
  },
  {
    body: 'measure up',
    meaning: 'to be good enough, or to be as good as someone/something else',
    example: 'I feel like I don’t measure up to my friends. They’re all successful businessmen.',
  },
  {
    body: "out of (one's) hands",
    meaning: "Not within one's control.",
    example: "I submitted my application, so it's really out of my hands now.",
  },
  {
    body: 'I’ve had it up to here with someone/something',
    meaning: 'you can’t handle that person or thing any longer.',
    example: 'I’ve had it up to here with all of his excuses! I already gave him enough chances to change.',
  },
  {
    body: 'blow up at someone',
    meaning: 'to suddenly burst into anger and yell at a person.',
    example: 'Yesterday, I blew up at Chris for criticizing my work.',
  },
  {
    ...
    example: 'If you want to be finished by Monday, you’ll have to get your act together.',
  },
  { body: 'over the moon', meaning: 'to be very pleased:', example: 'She was over the moon about/with her new bike.' },
  { body: 'birds of a feather', meaning: 'people who are similar in character', example: "He'll like Tony - they're birds of a feather." },
  {
    body: 'case in point',
    meaning: 'an example of the situation or behaviour that you are talking about',
    example: 'Shoppers tend to think that high prices mean high quality. Electrical goods are a case in point.',
  },
  {
    body: 'take the high road',
    meaning: 'to behave in a moral way when other people are not behaving morally:',
    example: 'He decided to take the high road and say he was sorry.',
  },
  {
  ...
  },
  {
    ...
    example: 'Teachers are thrown in the deep end when they first start teaching.',
  },
  {
    body: 'take a hit',
    meaning: 'to be badly affected in some way',
    example: "The region's economy will take a hit if the airbase is closed.",
  },
  {
    body: 'smooth saling',
    meaning: 'Used to describe an activity that is not encountering any problems.',
    example: "It's all been smooth sailing; everything has gone exactly according to plan.",
  },
  {
    body: 'hit and miss',
    meaning: 'If something is hit-and-miss, you cannot depend on it to be of good quality, on time, accurate, etc.:',
    example: 'The trains are often late, so getting to work on time is a fairly hit-and-miss affair.',
  },
  {
    body: 'brownie point',
    meaning: 'If someone does something to score brownie points, they do it because they think they will be praised for it.',
    example: "They're just trying to score brownie points with politicians.",
  },
  {
    body: 'a five-alarm fire',
    meaning: 'Someone or something that is very intense or stressful.',
    example: "Boy, this project has really become a five-alarm fire with all the other problems it's created.",
  },
  {
    body: 'someone gets your vote',
    meaning: 'if someone gets your vote, you support what they say or do',
    example: 'Anyone prepared to stand up to the bosses gets my vote.',
  },
  {
  ...
  },
  {
    ...
    example: 'The process of learning a language does not take place in a vacuum.',
  },
  {
    body: 'say in a roundabout way',
    meaning: 'To imply or convey something in an indirect, vague, or evasive manner.',
    example: "Well, he didn't promise it to me outright—he said it in a roundabout sort of way.",
  },
  {
    body: 'to and fro',
  ...
  { body: 'run-of-the-mill', meaning: 'not outstanding in quality or rarity', example: 'He gave a fairly run-of-the-mill speech.' },
  {
    body: 'once and for all',
    meaning: 'completely and finally:',
    example: 'We have to decide, once and for all, whether we want to ask Dad for money.',
  },
  {
    ...
    example: 'She swindles people under the guise of friendship.',
  },
  {
    body: 'for good',
    meaning: 'permanently, without the possibility of change in the future',
    example: 'It looks like Jamie has left for good this time.',
  },
  {
  ...
  },
  {
    ...
    example: 'Our country is leading a global campaign to stamp out child labor.',
  },
  {
    body: 'be exasperated by something',
    meaning: 'be very annoyed or angry at something.',
    example: 'Carol was exasperated by her mother’s never-ending questions.  ',
  },
  {
    body: 'crack down on',
    meaning: 'to start dealing with bad or illegal behaviour in a more severe way:',
    example: 'The school made new rules in order to crack down on bullying.',
  },
  {
    ...
    example: "said to show that you cannot know what something or someone is like by looking only at that person or thing's appearance",
  },
  {
    ...
    example: 'I came back two hours later to find the kids still had their eyes glued to the television.',
  },
  { body: 'be in the wrong', meaning: 'to make a mistake or deserve the blame for something', example: 'Which driver was in the wrong?' },
  {
    body: 'take the blame',
    meaning: 'to assume or be assigned the responsibillity or guilt for something.',
    example: 'As manager for this project, I tkae the blame for its failure.',
  },
  {
    body: 'less is more',
    meaning: 'you’re saying that something simple is better than something elaborate or complicated.',
    example: 'I always go for a clean, fresh look. When it comes to make-up, I think less is more.',
  },
  {
    body: 'too much of a good thing',
    meaning: 'something good can be bad if it’s done in excess.',
    example: 'You can have too much of a good thing.',
  },
  {
    body: 'a white lie',
    meaning: 'a lie that is told to be polite or to avoid upsetting someone with the truth.',
    example: 'Don’t tell him that! You’ll break his heart. Just tell him a white lie, like you have work or something.',
  },
  {
    body: 'read between the lines',
    meaning: "to try to understand someone's real feelings or intentions from what they say or write:",
  ...
  },
  {
    ...
    example: 'After dropping out of college once before, I really want to get this second chance off to a good start.',
  },
  {
    body: 'go south',
    meaning:
  ...
  },
  {
    ...
    example: "Ten to one he won't be there tonight.",
  },
  {
    body: "chink in (one's) armor ",
    meaning: 'A minor but very detrimental flaw or weakness.',
    example: "Yeah, he's brilliant, but his violent temper has destroyed many business relationships—it's really the chink in his armor.",
  },
  {
    body: 'hit (one) close to home',
    meaning: 'To affect one deeply and emotionally because one can relate very closely.',
    example: "My patient's lung cancer diagnosis hits me close to home because my uncle recently died of the same thing.",
  },
  {
    body: 'I was born ready',
    meaning: 'Meaning they are very ready and enthusiastic with whatever they are going to do.',
    example: '"You ready?" "I was born ready"',
  },
  {
    body: 'jump the gun',
  ...
  {
    body: 'can of worms',
    meaning: 'Corruption is a serious problem, but nobody has yet been willing to open up that can of worms.',
    example: 'Corruption is a serious problem, but nobody has yet been willing to open up that can of worms.',
  },
  { body: 'many moons ago', meaning: 'a long time ago', example: 'It all happened many moons ago.' },
  { body: 'fair and square', meaning: 'in an honest and fair manner', example: 'He won the election fair and square.' },
  {
    body: 'on the hook for',
    meaning: 'owing money for (something) : responsible for (something)',
    example: "He's still on the hook for the cost of the repairs.",
  },
  {
    ...
    example: 'Don’t take it out on me – I’m not your boss!',
  },
  {
    ...
    example: 'They really went to town on the Christmas decorations.',
  },
  {
    body: 'in retrospect',
    meaning: 'when looking back on a past event or situation; with hindsight.',
    example: "Perhaps, in retrospect, I shouldn't have gone.",
  },
  {
    body: 'lost cause',
    meaning: 'a person or thing that can no longer hope to succeed or be changed for the better.',
    example: 'Their opposition to planning for full employment was a lost cause.',
  },
  {
