import { S as SvelteComponent, i as init, s as safe_not_equal, k as element, a as space, l as claim_element, m as children, h as detach, c as claim_space, n as attr, J as toggle_class, b as insert_hydration, H as append_hydration, K as listen, C as noop, L as bubble, q as text, r as claim_text, u as set_data, f as transition_in, g as group_outros, d as check_outros, t as transition_out, M as destroy_each, N as onDestroy, x as create_component, y as claim_component, z as mount_component, A as destroy_component, O as run_all, P as createEventDispatcher, Q as assign, R as get_spread_update, T as get_spread_object, U as add_render_callback, V as create_in_transition, W as create_out_transition, v as binding_callbacks, X as bind, Y as head_selector, Z as add_flush_callback } from "../../chunks/index-f93a5465.js";
const colors_min = "";
const colorsHsl_min = "";
const fonts_min = "";
const sizes_min = "";
...
function scale(node, { delay = 0, duration: duration2 = 400, easing = cubicOut, start = 0, opacity = 0 } = {}) {
  const style = getComputedStyle(node);
  const target_opacity = +style.opacity;
  const transform = style.transform === "none" ? "" : style.transform;
  const sd = 1 - start;
...
const FaceButton_svelte_svelte_type_style_lang = "";
function create_fragment$5(ctx) {
  ...
  return {
    ...
    h() {
      attr(div0, "class", "eye left svelte-1eatjjw");
      attr(div1, "class", "eye right svelte-1eatjjw");
      attr(div2, "class", "eyes svelte-1eatjjw");
      attr(div3, "class", "mouth svelte-1eatjjw");
      attr(button, "class", button_class_value = "face " + /*type*/
      ctx[1] + " svelte-1eatjjw");
      toggle_class(
        button,
        "selected",
        /*selected*/
    ...
    p(ctx2, [dirty]) {
      if (dirty & /*type*/
      2 && button_class_value !== (button_class_value = "face " + /*type*/
      ctx2[1] + " svelte-1eatjjw")) {
        attr(button, "class", button_class_value);
      }
      if (dirty & /*type, selected*/
      3) {
        toggle_class(
          button,
          "selected",
...
function instance$5($$self, $$props, $$invalidate) {
  ...
  return [selected, type, click_handler];
}
class FaceButton extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$5, create_fragment$5, safe_not_equal, { selected: 0, type: 1 });
  }
}
const phrases = [
  {
  ...
  },
  {
    ...
    examples: [
      ...
      "It'll be when hell freezes over before that clown is allowed to run this great state of ours!"
    ]
  },
  {
    id: 19,
  ...
  },
  {
    ...
    examples: [
      "Are your taking the mickey of my mum?",
  ...
  },
  {
    ...
    examples: ["Janice said yes! They’re going to tie the knot later this year!"]
  },
  {
    id: 100,
  ...
  },
  {
    ...
    examples: [
      "Robert is 45 and his girlfriend is only 25. This isn't the first time he's robbed the cradle.",
  ...
  },
  {
    ...
    meaning: "talk to someone about the advantages of doing it until he/she agrees with you.",
    examples: [
  ...
  },
  {
    ...
    examples: [
      "Tom is truly generous—he'll give you the shirt off his back. ",
      "I'm not surprised that Tammy loaned you money—she would give anyone the shirt off her back."
    ]
  },
  {
    id: 146,
    body: "When in Rome, Do as the Romans Do",
    meaning: "importance of adapting yourself to the customs of the people who are in a certain place or situation and behave like they do.",
    examples: [
  ...
  },
  {
    ...
    meaning: "an exclamation that something is too exciting or overwhelming for one to bear; literally, that it is causing one's heart to beat too fast. In modern usage, it is almost always used sarcastically to imply that something is actually mundane, uninteresting, or unappealing.",
  ...
  },
  {
    ...
    meaning: "used when saying that you do not want to criticize someone or say what they should do, especially when this is what you are really about to do",
    examples: [
  ...
  },
  {
    ...
    meaning: "To exaggerate, overembellish, or overstate some emotional experience, response, or appeal, such as blame, praise, flattery, excuses, etc.",
    examples: [
  ...
  },
  {
    ...
    meaning: "American English spoken informal used to say that no one should be surprised that someone does something, because it is typical or expected of them",
  ...
  },
  {
    ...
    meaning: "In life, you will always succeed in some situations and fail in others. Used especially as consolation following some loss or failure.",
    examples: [
  ...
  },
  {
    ...
    meaning: 'If you say "eat your heart out" followed by the name of a famous person, you are joking that you are even better than that person:',
    examples: [
  ...
  },
  {
    id: 212,
    body: "be all in",
    meaning: "to be fully committed to a task or endeavor; to give or be prepared to give all of one's energy or resources toward something.",
    examples: [
  ...
  },
  {
    ...
    examples: [
      "I'm not asking for special treatment, just give me a fair shake at the tryouts.",
  ...
  },
  {
    ...
    meaning: "The responsibility of those who are of a higher authority than oneself, denoted by the level of pay that one receives in comparison to one's superiors.",
    examples: [
  ...
  },
  {
    id: 233,
    body: "case in point",
    meaning: "an example of the situation or behavior that you are talking about",
    examples: [
  ...
  },
  {
    ...
    meaning: "used in phrases such as throw in (at) the deep end and jump in (at) the deep end to describe starting a new and difficult activity when one is not fully prepared or ready to do it",
    examples: [
  ...
  },
  {
    ...
    examples: [
      ...
      "If we can just get the application approved, it should be smooth sailing from there."
    ]
  },
  {
    id: 239,
  ...
  },
  {
    ...
    examples: [
      ...
      "You need to bring the kids to a place where they can run to and fro without restriction for a while."
    ]
  },
  {
    id: 248,
  ...
  },
  {
    id: 258,
    body: "take the blame",
    meaning: "to assume or be assigned the responsibility or guilt for something.",
    examples: ["As manager for this project, I take the blame for its failure."]
  },
  {
    id: 259,
    body: "less is more",
  ...
  },
  {
    ...
    examples: [
      "After dropping out of college once before, I really want to get this second chance off to a good start.",
  ...
  },
  {
    id: 263,
    body: "go south",
    meaning: "American English informal if a situation, organization, or set of standards goes south, it becomes very bad although it was once very good",
  ...
  },
  {
    ...
    meaning: 'When someone states an opinion that is similar to yours, but differs in intensity, then you can say that their opinion is "one way of putting it". ',
    examples: [
  ...
  },
  {
    ...
    meaning: "Extremely busy (with something); deeply or overly involved (in something); possessing, filled up with, or overwhelmed by an excessive amount (of something).",
    examples: [
  ...
  },
  {
    ...
    meaning: "To informally or casually attempt to gauge the reaction of a potential audience or recipient of something, or to try to get an idea of what something will be like before actually doing it.",
    examples: [
  ...
  },
  {
    ...
    meaning: "If you say that you will do something come hell or high water, you mean that you are determined to do it, despite any difficulties that there might be:",
    examples: [
  ...
  },
  {
    id: 332,
    body: "force of habit",
    meaning: "An impulse to do something because one does or has done it habitually. Used to describe an unconscious mistake that results from following one's routine rather than choosing the correct action for the circumstances.",
    examples: [
  ...
  },
  {
    ...
    meaning: "although someone says things that sound frightening, the person's actions will not be as severe as the things that were said:",
    examples: [
  ...
  },
  {
    ...
    meaning: "If you are back to square one, you have to start working on a plan from the beginning because your previous attempt failed completely:",
    examples: [
  ...
  },
  {
    ...
    examples: ["We all cracked up at Josh's joke.", "That comedian just cracks me up."]
  },
  {
    id: 345,
  ...
  },
  {
    ...
    meaning: "You say 'Not that I know of' when someone has asked you whether or not something is true and you think the answer is 'no' but you cannot be sure because you do not know all the facts. ",
  ...
  },
  {
    ...
    meaning: "problems that someone has had in the past that they do not worry about because they happened a long time ago and cannot now be changed: ",
    examples: [
  ...
  },
  {
    id: 391,
    body: "a fine line",
    meaning: "If you say that there is a fine line between one thing and another, you mean that they are very similar. You often say this when one thing is acceptable and the other is not: ",
    examples: [
  ...
  },
  {
    ...
    meaning: "To attempt to appease or placate someone by giving them something trivial or of minor importance or by doing some small favor for them. (A reference to giving a dog a bone or scrap from a bigger portion of food.)",
    examples: [
  ...
  },
  {
    id: 398,
    body: "fast and loose",
    meaning: "If you say that someone is playing fast and loose, you are expressing disapproval of them for behaving in a deceitful, immoral, or irresponsible way. ",
    examples: [
  ...
  },
  {
    id: 401,
    body: "chip away at",
    meaning: "If you chip away at something such as an idea, a feeling, or a system, you gradually make it weaker or less likely to succeed by repeated efforts. ",
    examples: [
  ...
  },
  {
    ...
    meaning: "to do or experience something unpleasant, or accept blame or punishment for something, so that other members of a group do not have to",
    examples: [
  ...
  },
  {
    id: 418,
    body: "strike a deal ",
    meaning: "to reach an agreement, especially on the conditions set by two people or groups",
    examples: ["The clothing brand struck a deal with a popular marketing agency for a new ad."]
  },
  {
    id: 419,
    body: "A game",
  ...
  },
  {
    id: 421,
    body: "pull aside",
    meaning: "to take (someone) to one side away from other people for a private conversation",
    examples: [
  ...
  },
  {
    ...
    meaning: "If you have your pick of a group of things, you are able to choose any of them that you want.",
    examples: [
  ...
  },
  {
    ...
    meaning: "used to say that one could give more information about something but that the statement that follows is enough",
    examples: ["Suffice to say, she has a lot on her hands with four children."]
  },
  {
    id: 427,
  ...
  },
  {
    ...
    meaning: 'Without any problems at all; very smoothly, easily, or effortlessly. Used especially after "go off."',
    examples: [
  ...
  },
  {
    ...
    meaning: "to protect yourself against loss by supporting more than one possible result or both sides in a competition:",
    examples: [
  ...
  },
  {
    id: 439,
    body: "on the verge",
    meaning: "at the point when (something) is about to happen or is very likely to happen",
    examples: [
...
const words = [
  {
    id: 1,
    body: "condescending",
    meaning: "having or showing an attitude of patronizing superiority.",
    examples: [
  ...
  },
  {
    id: 13,
    body: "innuendo",
    meaning: "a remark or remarks that suggest something sexual or something unpleasant but do not refer to it directly:",
  ...
  },
  {
    id: 16,
    body: "Inexactitude",
    meaning: "lack of accuracy or precision.",
    examples: [
  ...
  },
  {
    id: 34,
    body: "empirical",
    meaning: "capable of being verified or disproved by observation or experiment (ex. qualitative data and quantitative data)",
...
function supportsSpeech() {
  return window.speechSynthesis !== void 0;
}
...
function create_each_block(ctx) {
  ...
  facebutton.$on("click", click_handler);
  return {
    c() {
      create_component(facebutton.$$.fragment);
    },
    l(nodes) {
      claim_component(facebutton.$$.fragment, nodes);
    },
    m(target, anchor) {
      mount_component(facebutton, target, anchor);
      current = true;
    },
    p(new_ctx, dirty) {
      ctx = new_ctx;
      const facebutton_changes = {};
      if (dirty & /*selectedIndex*/
      2)
        facebutton_changes.selected = /*selectedIndex*/
        ctx[1] === /*i*/
        ctx[11];
      facebutton.$set(facebutton_changes);
    },
    i(local) {
      if (current)
        return;
      transition_in(facebutton.$$.fragment, local);
      current = true;
    },
    o(local) {
      transition_out(facebutton.$$.fragment, local);
      current = false;
    },
    d(detaching) {
      destroy_component(facebutton, detaching);
    }
  };
}
function create_fragment$4(ctx) {
  ...
  return {
    ...
    h() {
      attr(p, "class", "example svelte-1rw2jyq");
      attr(div0, "class", "button-container svelte-1rw2jyq");
      attr(div1, "class", "example-container svelte-1rw2jyq");
    },
    m(target, anchor) {
    ...
    p(ctx2, [dirty]) {
      ...
      if (dirty & /*selectedIndex, selectExample, examples*/
      11) {
        each_value = /*examples*/
        ctx2[0];
        let i;
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  function setExample() {
    $$invalidate(2, exampleText = setNewLine(examples[selectedIndex]));
  }
  ...
  const click_handler = (i) => selectExample(i);
  $$self.$$set = ($$props2) => {
...
class Example extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$4, create_fragment$4, safe_not_equal, { examples: 0 });
  }
}
const PhraseCard_svelte_svelte_type_style_lang = "";
function create_fragment$3(ctx) {
  ...
  let mounted;
  let dispose;
  example_1 = new Example({ props: { examples: (
    /*examples*/
    ctx[2]
  ) } });
  return {
    c() {
      ...
      t3 = space();
      create_component(example_1.$$.fragment);
      t4 = space();
      div = element("div");
    ...
    l(nodes) {
      ...
      claim_component(example_1.$$.fragment, section_nodes);
      t4 = claim_space(section_nodes);
      div = claim_element(section_nodes, "DIV", { class: true });
      var div_nodes = children(div);
      button0 = claim_element(div_nodes, "BUTTON", { class: true });
      var button0_nodes = children(button0);
      t5 = claim_text(button0_nodes, "Back");
      button0_nodes.forEach(detach);
      t6 = claim_space(div_nodes);
      button1 = claim_element(div_nodes, "BUTTON", { class: true });
      var button1_nodes = children(button1);
      t7 = claim_text(button1_nodes, "Next");
    ...
    h() {
      attr(h1, "class", "phrase svelte-1k2surf");
      attr(p, "class", "meaning svelte-1k2surf");
      attr(button0, "class", "next-button svelte-1k2surf");
      attr(button1, "class", "next-button svelte-1k2surf");
      attr(div, "class", "next-button-wrapper svelte-1k2surf");
      attr(section, "class", "card-section svelte-1k2surf");
    },
    m(target, anchor) {
      ...
      mount_component(example_1, section, null);
    ...
    p(ctx2, [dirty]) {
      ...
      const example_1_changes = {};
      if (dirty & /*examples*/
      4)
        example_1_changes.examples = /*examples*/
        ctx2[2];
      example_1.$set(example_1_changes);
    },
    i(local) {
      if (current)
        return;
      transition_in(example_1.$$.fragment, local);
      current = true;
    },
    o(local) {
      transition_out(example_1.$$.fragment, local);
      current = false;
    },
    d(detaching) {
      if (detaching)
        detach(section);
      destroy_component(example_1);
      mounted = false;
      run_all(dispose);
    }
  };
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("meaning" in $$props2)
      $$invalidate(1, meaning = $$props2.meaning);
    if ("examples" in $$props2)
      $$invalidate(2, examples = $$props2.examples);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*examples*/
    4) {
      $$invalidate(5, example = examples[0]);
    }
    if ($$self.$$.dirty & /*example*/
    32)
      ;
  };
  return [body, meaning, examples, next, back, example];
}
class PhraseCard extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$3, create_fragment$3, safe_not_equal, { body: 0, meaning: 1, examples: 2 });
  }
}
const PhraseCardPager_svelte_svelte_type_style_lang = "";
function create_else_block(ctx) {
  ...
  let div_outro;
  let current;
  const phrasecard_spread_levels = [
    /*phrase2*/
    ctx[3]
  ];
  let phrasecard_props = {};
  for (let i = 0; i < phrasecard_spread_levels.length; i += 1) {
    phrasecard_props = assign(phrasecard_props, phrasecard_spread_levels[i]);
  }
  phrasecard = new PhraseCard({ props: phrasecard_props });
  phrasecard.$on(
    "next",
    /*next_handler_1*/
    ctx[11]
  ...
  return {
    c() {
      div = element("div");
      create_component(phrasecard.$$.fragment);
      this.h();
    },
    l(nodes) {
      div = claim_element(nodes, "DIV", { id: true, class: true });
      var div_nodes = children(div);
      claim_component(phrasecard.$$.fragment, div_nodes);
      div_nodes.forEach(detach);
      this.h();
    },
    h() {
      attr(div, "id", "card-holder-2");
      attr(div, "class", "card-holder svelte-9w63xn");
      toggle_class(
        div,
        "above",
        /*phrase1Visible*/
    ...
    m(target, anchor) {
      ...
      mount_component(phrasecard, div, null);
      current = true;
    },
    p(ctx2, dirty) {
      const phrasecard_changes = dirty & /*phrase2*/
      8 ? get_spread_update(phrasecard_spread_levels, [get_spread_object(
        /*phrase2*/
        ctx2[3]
      )]) : {};
      phrasecard.$set(phrasecard_changes);
      if (!current || dirty & /*phrase1Visible, next*/
      3) {
        toggle_class(
          div,
          "above",
    ...
    i(local) {
      if (current)
        return;
      transition_in(phrasecard.$$.fragment, local);
      add_render_callback(() => {
        if (div_outro)
          div_outro.end(1);
    ...
    o(local) {
      transition_out(phrasecard.$$.fragment, local);
      if (div_intro)
...
function create_if_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      const phrasecard_changes = dirty & /*phrase1*/
      4 ? get_spread_update(phrasecard_spread_levels, [get_spread_object(
        /*phrase1*/
        ctx2[2]
      )]) : {};
      phrasecard.$set(phrasecard_changes);
...
function create_fragment$2(ctx) {
  ...
  return {
    ...
    h() {
      attr(div, "class", "card-container svelte-9w63xn");
    },
    m(target, anchor) {
      insert_hydration(target, div, anchor);
...
function instance$2($$self, $$props, $$invalidate) {
  ...
  function back_handler(event) {
    bubble.call(this, $$self, event);
  }
  function next_handler_1(event) {
    bubble.call(this, $$self, event);
  }
  function back_handler_1(event) {
    bubble.call(this, $$self, event);
  }
  $$self.$$set = ($$props2) => {
    if ("body" in $$props2)
      $$invalidate(6, body = $$props2.body);
    if ("meaning" in $$props2)
      $$invalidate(7, meaning = $$props2.meaning);
    if ("examples" in $$props2)
      $$invalidate(8, examples = $$props2.examples);
    if ("next" in $$props2)
      $$invalidate(0, next = $$props2.next);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*phrase1Visible, body, meaning, examples*/
    450) {
      {
        if (phrase1Visible) {
          $$invalidate(3, phrase2 = { body, meaning, examples });
        } else {
          $$invalidate(2, phrase1 = { body, meaning, examples });
        }
        $$invalidate(1, phrase1Visible = !phrase1Visible);
        setZIndex();
      }
    }
  };
...
class PhraseCardPager extends SvelteComponent {
  constructor(options) {
    super();
...
const ModeSwitch_svelte_svelte_type_style_lang = "";
function create_fragment$1(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      button0 = claim_element(div_nodes, "BUTTON", { class: true });
      var button0_nodes = children(button0);
      t0 = claim_text(button0_nodes, "Phrases");
      button0_nodes.forEach(detach);
      t1 = claim_space(div_nodes);
      button1 = claim_element(div_nodes, "BUTTON", { class: true });
      var button1_nodes = children(button1);
      t2 = claim_text(button1_nodes, "Words");
      button1_nodes.forEach(detach);
      div_nodes.forEach(detach);
      this.h();
    },
    h() {
      attr(button0, "class", "switch-button svelte-16qhp4h");
      toggle_class(
        button0,
        "active",
        /*mode*/
      ...
      attr(button1, "class", "switch-button svelte-16qhp4h");
      toggle_class(
        button1,
        "active",
        /*mode*/
      ...
      attr(div, "class", "wrapper svelte-16qhp4h");
    },
    m(target, anchor) {
      insert_hydration(target, div, anchor);
      append_hydration(div, button0);
...
function instance$1($$self, $$props, $$invalidate) {
  let { mode = "phrase" } = $$props;
  const click_handler = () => $$invalidate(0, mode = "phrase");
  const click_handler_1 = () => $$invalidate(0, mode = "word");
  $$self.$$set = ($$props2) => {
    if ("mode" in $$props2)
...
class ModeSwitch extends SvelteComponent {
  constructor(options) {
    super();
...
function create_fragment(ctx) {
  ...
  let phrasecardpager;
  let current;
  function modeswitch_mode_binding(value) {
    ctx[7](value);
  }
  ...
  if (
    ...
    modeswitch_props.mode = /*mode*/
    ctx[0];
  }
  modeswitch = new ModeSwitch({ props: modeswitch_props });
  binding_callbacks.push(() => bind(modeswitch, "mode", modeswitch_mode_binding));
  const phrasecardpager_spread_levels = [
    /*phrase*/
    ctx[2],
    { next: (
      /*next*/
  ...
  let phrasecardpager_props = {};
  for (let i = 0; i < phrasecardpager_spread_levels.length; i += 1) {
    phrasecardpager_props = assign(phrasecardpager_props, phrasecardpager_spread_levels[i]);
  }
  phrasecardpager = new PhraseCardPager({ props: phrasecardpager_props });
  phrasecardpager.$on(
    "next",
    /*setNextPhrase*/
    ctx[3]
  ...
  return {
    c() {
      ...
      t1 = space();
      create_component(phrasecardpager.$$.fragment);
      this.h();
    },
    l(nodes) {
      const head_nodes = head_selector("svelte-1sj43r4", document.head);
      ...
      claim_component(phrasecardpager.$$.fragment, main_nodes);
      main_nodes.forEach(detach);
      this.h();
    },
    h() {
      document.title = "English Cards";
      attr(meta, "name", "description");
      attr(meta, "content", "Learn and memorize English words and phrases!");
      attr(main, "class", "svelte-1ckt756");
    },
    m(target, anchor) {
      ...
      mount_component(phrasecardpager, main, null);
      current = true;
    },
    p(ctx2, [dirty]) {
      const modeswitch_changes = {};
      if (!updating_mode && dirty & /*mode*/
      1) {
        updating_mode = true;
        modeswitch_changes.mode = /*mode*/
        ctx2[0];
        add_flush_callback(() => updating_mode = false);
      }
      modeswitch.$set(modeswitch_changes);
      const phrasecardpager_changes = dirty & /*phrase, next*/
      6 ? get_spread_update(phrasecardpager_spread_levels, [
        dirty & /*phrase*/
        4 && get_spread_object(
          /*phrase*/
          ctx2[2]
      ...
      phrasecardpager.$set(phrasecardpager_changes);
    },
    i(local) {
      if (current)
        return;
      transition_in(modeswitch.$$.fragment, local);
      transition_in(phrasecardpager.$$.fragment, local);
      current = true;
    },
    o(local) {
      transition_out(modeswitch.$$.fragment, local);
      transition_out(phrasecardpager.$$.fragment, local);
      current = false;
    },
    d(detaching) {
      detach(meta);
      ...
      destroy_component(phrasecardpager);
    }
  };
}
function instance($$self, $$props, $$invalidate) {
  ...
  let phrases2 = [];
  const setNextPhrase = () => {
    $$invalidate(5, index = index < phrases2.length - 1 ? index + 1 : 0);
    $$invalidate(1, next = true);
  };
  const setPreviousPhrase = () => {
    $$invalidate(5, index = index > 0 ? index - 1 : phrases2.length - 1);
    $$invalidate(1, next = false);
  };
  function modeswitch_mode_binding(value) {
    mode = value;
    $$invalidate(0, mode);
  ...
  $$self.$$.update = () => {
    ...
    1) {
      {
        $$invalidate(6, phrases2 = fetchPhrases(mode));
      }
    }
    if ($$self.$$.dirty & /*phrases, index*/
    96) {
      $$invalidate(2, phrase = phrases2[index]);
    }
  };
  return [
    mode,
